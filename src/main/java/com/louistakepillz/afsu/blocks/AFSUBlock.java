package louistakepillz.afsu.blocks;
...
import louistakepillz.afsu.AFSUMod;
...
public class AFSUBlock extends Block {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int var6, float var7, float var8, float var9){
        ...
        if (equippedItem == IC2Items.getItem("wrench").getItem() || equippedItem == IC2Items.getItem("electricWrench").getItem()) {
            return true;
        }
